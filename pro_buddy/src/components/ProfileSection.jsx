...
export default function ProfileSection({ onNavigate, onScrollTo }) {
    ...
    useEffect(() => {
        if (user) {
            apiGetEvaluations().then(r => { if (r.success) setHistory(r.evaluations); }).catch(() => {});
        }
    }, [user]);
    ...
    const joinedDate = user?.createdAt ? (() => { const d = user.createdAt.toDate ? user.createdAt.toDate() : new Date(user.createdAt); const m = ['Jan','Feb','Mar','Apr','May','Jun','Jul','Aug','Sep','Oct','Nov','Dec']; return `${m[d.getMonth()]} ${d.getFullYear()}`; })() : '—';
    ...
    async function clearHistory() {
        ...
        try {
            ...
            localStorage.removeItem(`probuddy_history_${user.email}`);
        } catch {
            // Ignore
        }
        setHistory([]);
                ...
                <div className="profile-layout">
                    <div className="profile-header-card">
                        ...
                        <div className="profile-info-row">
                            ...
                            <button className="btn btn-ghost btn-sm" onClick={openEdit}> Edit Profile</button>
                        </div>
                    </div>
                    ...
                    <div className="profile-history">
                        ...
                        <div className="history-list">
                            {history.length === 0 ? (
                                ...
                                const d = entry.createdAt && entry.createdAt.toDate ? entry.createdAt.toDate() : new Date(entry.timestamp || entry.createdAt);
