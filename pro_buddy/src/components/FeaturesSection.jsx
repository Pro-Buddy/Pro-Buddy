export default function FeaturesSection() {
    const features = [
        ...
        { id: 'featureTechStack', icon: '', title: 'Tech Stack Required', desc: 'Recommends the ideal technology stack for your project and evaluates how well your current choices match the requirements.', tag: 'Stack Readiness' },
    ];
