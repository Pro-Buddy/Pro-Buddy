...
export default function Forum({ onNavigate }) {
    ...
    return (
        <div className="community-wrapper" style={{ paddingTop: '20px' }}>
            ...
            {/* Professional-Style Community Banner */}
            ...
            <div className="community-layout-grid">
                ...
                <main className="community-center-col">
                    {/* Professional-Style Post Trigger Card */}
                    <div className="community-card composer-trigger-card">
                    ...
                    {filteredPosts.length === 0 ? (
                        <div className="community-card" style={{ padding: '40px 20px', textAlign: 'center' }}>
                        ...
                        filteredPosts.map(post => {
                            ...
                            return (
                                <article key={post.id} className="community-card community-post-card">
                                    {/* Author & Header */}
                                    ...
                                    {/* Interaction Action Row (Professional Style) */}
                ...
                <aside className="community-right-col">
                    ...
                    {/* Community Charter */}
                    <div className="community-card" style={{ padding: '16px' }}>
