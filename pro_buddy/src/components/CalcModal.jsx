        ...
        <div className={`modal-backdrop${show ? ' show' : ''}`} id="calcModal" style={{ display: 'flex' }}
            ...
            <div className="modal-content">
                ...
                <div className="modal-body">
                    <div className="param-group" style={{ borderLeftColor: '#E64A19' }}>
                        <h4 style={{ color: '#E64A19' }}> Pro Evaluator: Project Analysis (Deep Orange)</h4>
                    ...
                    <div className="param-group" style={{ borderLeftColor: '#ff5722' }}>
                        <h4 style={{ color: '#ff5722' }}> Pro Careers: Job Matching (Vibrant Saffron)</h4>
                        <p className="param-desc">Matches your skills and interests with curated remote job board categories and career exploration portals.</p>
                        <ul>
                    ...
                    <div className="param-group" style={{ borderLeftColor: '#FF9F76' }}>
                        <h4 style={{ color: '#FF9F76' }}> Pro Study: Learning Paths (Warm Peach)</h4>
