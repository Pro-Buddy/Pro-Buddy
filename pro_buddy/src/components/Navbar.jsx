...
export default function Navbar({ currentView, onNavigate, onScrollTo }) {
    ...
    const handleNavClick = (e, viewOrId) => {
        e.preventDefault();
        if (['main', 'dashboard', 'evaluator', 'careers', 'study', 'profile', 'forum', 'admin'].includes(viewOrId)) {
            onNavigate(viewOrId);
        } else {
        ...
        <nav id="navbar" className={scrolled ? 'scrolled' : ''}>
            <div className="nav-container">
                ...
                <div className="nav-links">
                    ...
                    <a href="#" className={`nav-link${isActive('forum')}`} onClick={(e) => handleNavClick(e, 'forum')}>Community</a>
                </div>
                    ...
                    <div className="user-menu" id="userMenu" ref={dropdownRef}>
                        ...
                        <div className={`user-dropdown${dropdownOpen ? ' show' : ''}`} id="userDropdown">
                            ...
                            {user?.email === 'vishwarojushiva273@gmail.com' && (
                                <a href="#" className="dropdown-item" onClick={(e) => { e.preventDefault(); setDropdownOpen(false); onNavigate('admin'); }}>
