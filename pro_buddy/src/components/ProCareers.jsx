    ...
    async function analyze() {
        ...
        try {
            ...
            if (data.success) {
                ...
                showToast('⚠️ Failed to fetch careers: ' + data.message);
            }
        } catch (err) {
        ...
        <section className="suggest-section" id="proCareers" style={{ paddingTop: '20px' }}>
            ...
            <div className="section-container">
                <div className="section-header">
                    <span className="section-tag" style={{ background: '#FFB199', color: '#111111', fontWeight: '600', padding: '6px 16px', borderRadius: '50px' }}>Career Navigator</span>
