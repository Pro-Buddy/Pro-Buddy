    ...
    async function search() {
        ...
        try {
            ...
            if (data.success) {
                ...
                showToast('⚠️ Failed to fetch study resources: ' + data.message);
            }
        } catch (err) {
        ...
        <section className="study-section" id="proStudy" style={{ paddingTop: '20px' }}>
            ...
            <div className="section-container">
                <div className="section-header">
                    <span className="section-tag" style={{ background: '#FFB199', color: '#111111', fontWeight: '600', padding: '6px 16px', borderRadius: '50px' }}>Learning Guide</span>
                            ...
                            <div className="study-web-grid">
                                {result.websites.map((w, i) => (
                                    <EmbedWrapper url={w.url} title={w.name} fallbackClass="study-web-card" key={i}>
                                        ...
                                        <p className="study-web-desc">{w.desc}</p></EmbedWrapper>
                                ))}
                            </div>
                        </div>
                    </div>
