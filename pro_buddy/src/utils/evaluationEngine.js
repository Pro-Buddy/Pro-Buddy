...
function calculateDifficulty(formData, allText, stackDifficultyAvg, stackCount) {
    ...
    score += (stackCount > 4 ? 8 : stackCount * 2);
...
function calculateSuccess(formData, allText, teamSize, stackCount) {
    ...
    if (stackCount > 6) score -= 8;
    else if (stackCount >= 2) score += 4;
...
function calculateTechKnowledge(formData, allText, stackCount, requiredSkills) {
    ...
    if (requiredSkills && requiredSkills.size > 0) {
        score += Math.min(requiredSkills.size * 3, 18);
    }
...
function calculateTechStackReq(formData, allText, stackCount) {
    let score = 30;
    score += Math.min(stackCount * 6, 24);
...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
 ...
 DIMENSION SCORES:
   ...
   Tech Stack Readiness:   ${scores.techStack}%  ${getBar(scores.techStack)}
