...
app.post('/api/careers', async (req, res) => {
    ...
    try {
        ...
        res.json({
            success: true,
            roles: [
                { title: "Software Engineer", company: "Tech Solutions Inc.", salary: "$70k - $90k", category: "Engineering", skills: ["JavaScript", "React"], link: "https://linkedin.com/jobs" },
                { title: "Frontend Developer", company: "Creative Web Agency", salary: "$60k - $80k", category: "Engineering", skills: ["HTML", "CSS", "React"], link: "https://linkedin.com/jobs" }
            ],
            explore: [
                { label: "LinkedIn Jobs", desc: "Find open roles here.", url: "https://linkedin.com/jobs" },
                { label: "Glassdoor", desc: "Research companies and salaries.", url: "https://glassdoor.com" }
            ]
        });
    }
});
...
app.post('/api/study', async (req, res) => {
    ...
    try {
        ...
        res.json({
            success: true,
            result: {
                label: topic || "Web Development",
                description: "Learn how to build applications and understand the core concepts.",
                youtube: [
                    { channel: "Traversy Media", title: "Crash Course", url: `https://youtube.com/results?search_query=${encodeURIComponent(topic || 'web development')}`, lang: "English" }
                ],
                websites: [
